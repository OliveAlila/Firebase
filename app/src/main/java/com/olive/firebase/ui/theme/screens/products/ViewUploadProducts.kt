package com.olive.firebase.ui.theme.screens.products
...
import com.olive.firebase.data.productviewmodel
import com.olive.firebase.model.Upload
import com.olive.firebase.navigation.ROUTE_UPDATEPRODUCTS
...
fun UploadItem(name:String, quantity:String, price:String, imageUrl:String, id:String,
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Button(onClick = {
            navController.navigate(ROUTE_UPDATEPRODUCTS+"/$id")
        }) {
            Text(text = "Update")
        }
    }
...
private fun Any.rememberAsyncImagePainter(imageUrl: String): Painter {
